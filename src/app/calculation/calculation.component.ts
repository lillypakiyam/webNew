...
export class CalculationComponent implements OnInit {
           ...
           service.getDistanceMatrix(request, (result:any, status:any) => {
             ...
             if(status === "OK"){
              ...
              eta = Math.round(result.rows[0].elements[0].duration.value)/60;
               ...
               this.minutes = eta
               resolve(true);
               console.log('eta minutes',eta, this.minutes);
               console.log('eta result.rows[0]',result.rows[0]);
         ...
         this.api.getJHLPR().pipe(take(1)).subscribe(rsfare => {
           ...
           if(this.api.vehicle_type === 'car'){
             if(this.api.furniture_ass === 'Yes'){
               // let hrs :number
               var furniture_hrs = (this.helperTimecalculate -eta) - hlpr.free_load_mints
               this.totalLoad = furniture_hrs
               console.log('furni hrs', furniture_hrs)
              //  var timeget = (this.helperTimecalculate -eta) - hlpr.free_load_mints
              //  console.log("load start+unload end", '-', 'distance duration',"-", "freetime", "=", timeget)
               console.log(this.helperTimecalculate, '-', eta,"-",hlpr.free_load_mints, "=", this.totalLoad)
               if(furniture_hrs <= 0){
           ...
           if(furniture_hrs <= 0){ //   -->
              ...
              if(this.vatAdd === true){
               ...
               // this.tripFare.fare1 =  Math.round(this.fareCalculator(vehicles1, dist) + this.calculateHLPFr(hlpr, eta));
                   ...
                   this.vatAddnone= true
                   console.log('tripFare_fare1',this.tripFare.fare1);
                   console.log('helper time', tripFare_fare1, "+", 0,
                 ...
                 if(this.vatAdd === false){
                   ...
                   // this.tripFare.fare1 =  Math.round(this.fareCalculator(vehicles1, dist) + this.calculateHLPFr(hlpr, eta));
                       ...
                       this.vatAddnone= true
                       console.log('tripFare_fare1',this.tripFare.fare1);
                       console.log('helper time', tripFare_fare1,"+", 0, "=", this.tripFare.fare1);
                     }
              ...
              this.api.fare1 = Math.round(this.tripFare.fare1);
               ...
               // this.tripFare.fare1 =  Math.round(this.fareCalculator(vehicles1, dist) + this.calculateHLPFr(hlpr, eta));
                   ...
                   this.vatAddnone= true
                   console.log('tripFare_fare1',this.tripFare.fare1);
                   console.log('helper time', tripFare_fare1, "+", this.totalLoad,
                   "+", Math.round(tripe_car * (17/100)),
                   "=", this.tripFare.fare1);
                 }
                 if(this.vatAdd === false){
           ...
           if(this.api.vehicle_type === 'helper'){
             ...
             if(this.selectValue === '1'){
               ...
               var furniture_total_mints = (this.helperTimecalculate -eta) - hlpr.free_load_mints
              ...
              //  var furniture_total_mints = furniture_hrss - hlpr.free_load_mints
               ...
               console.log('total load time', "=",furniture_total_mints, "-", hlpr.free_load_mints)
  ...
  //       minutes = Math.round(result.rows[0].elements[0].duration.value)/60;
  //        this.searchText=distance
  //        resolve(true);
  //        console.log('eta minutes',minutes);
  //        console.log('eta result.rows[0]',result.rows[0]);
  //        console.log('dist',distance,'serdist',this.searchText);
  //      }else{
  //       //  console.log('Error Occurred');
  //        resolve(false);
  //      }
